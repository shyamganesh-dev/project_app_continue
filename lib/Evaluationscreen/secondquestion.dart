      ...
      child: Scaffold(
        ...
        body: Column(
          ...
          children: [
            ...
            Text(Bar().adj,style: TextStyle(fontSize:18 ,fontWeight: FontWeight.bold,),),
            SizedBox(
              height: heights.height*0.02,
            ),
            Row(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    //color: Bar().purp,
                    borderRadius: BorderRadius.circular(5),
                      border: Border.all(color: Bar().purp)
                  ),
                  child: Center(
                      child: Center(child: Text("5",style: TextStyle(fontSize: 22,color: Bar().purp),)
                        )
